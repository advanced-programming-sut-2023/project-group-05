...
public class GameGraphicalController {
    ...
    private static void initMouse() {
        mouse = new Polygon(0, 0, mouseHeight * TILE_WIDTH / 2, (double) (mouseHeight * TILE_HEIGHT) / 2, (double) ((mouseHeight - mouseWidth) * TILE_WIDTH) / 2, (mouseHeight + mouseWidth) * TILE_HEIGHT / 2, (double) (-mouseWidth * TILE_WIDTH) / 2, (double) (mouseWidth * TILE_HEIGHT) / 2);
        ...
        mouse.setOnMouseClicked(new EventHandler<>() {
            @Override
