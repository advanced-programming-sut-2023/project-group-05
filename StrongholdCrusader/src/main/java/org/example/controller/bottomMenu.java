...
public class bottomMenu {
    ...
    private static String chosenBuilding = GameGraphicalController.chosenBuilding;
    ...
    private static int mouseHeight = GameGraphicalController.mouseHeight;
    private static int mouseWidth = GameGraphicalController.mouseWidth;
    ...
    static {
        ...
        info.setFill(new ImagePattern(new Image("images/icons/info.png")));
    ...
    static {
        ...
        receiveTrade.setFill(new ImagePattern(new Image(MainMenu.class.getResource("/images/receiveTrade.png").toString())));
