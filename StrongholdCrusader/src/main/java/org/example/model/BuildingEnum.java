...
public enum BuildingEnum {
    ...
    DEFENCE_TURRET("defencetower",new ArrayList<Integer>(Arrays.asList(3,3)) , 2000 ),
    SQUARE_TOWER("squaretower",new ArrayList<Integer>(Arrays.asList(3,3)) , 4000 ),
    ROUND_TOWER("roundtower",new ArrayList<Integer>(Arrays.asList(3,3)) , 2000 ),
    ARMOURY("armoury",new ArrayList<Integer>(Arrays.asList(3,3)) , 2000 ),
    BARRACKS("barracks",new ArrayList<Integer>(Arrays.asList(3,3)) , 2000 ),
    ...
    SIEGE_TENT("siegetent",new ArrayList<Integer>(Arrays.asList(4,4)) , 300 ),
