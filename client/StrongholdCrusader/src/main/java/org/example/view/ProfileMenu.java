...
public class ProfileMenu extends Application {
    ...
    private void setSubmitButton(Pane hBox, Text error, int mode, TextField textField,TextField newPassword) {
        ...
        submit.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                else if (mode == 5 && !textField.getText().equals( GameController.currentPassword ))
                    new Alert( Alert.AlertType.ERROR,"Old Password Is Wrong" ).showAndWait();
                else if (mode == 5){
                    if( !SignupLoginMenuController.changeThing( newPassword.getText(), mode ) ){
                        switch(mode){
    ...
    private void setBackButton(BorderPane pane) {
        ...
        back.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                update();
                initData( data );
                pane.getChildren().addAll(welcome, change, data,avt,back);
                back.setOnMouseClicked( new EventHandler <MouseEvent>() {
                    @Override
                    public void handle( MouseEvent mouseEvent ){
                        try {
    ...
    private void changeThings(BorderPane pane, int mode) {
        ...
        setSubmitButton(hBox, error, mode,input,null);
        pane.setCenter(hBox);
    }
    ...
    private void changePassword(BorderPane pane) {
        ...
        setSubmitButton(vBox,error,5,oldPass,newPass);
        pane.setCenter(vBox);
    }
