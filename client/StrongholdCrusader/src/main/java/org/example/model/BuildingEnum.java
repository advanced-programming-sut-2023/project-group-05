...
public enum BuildingEnum {
    ...
    TANNER("tanner",new ArrayList<>(Arrays.asList(2,2)),100),
    GT1("gt1",new ArrayList<>(Arrays.asList(1,1)),50),
    GT2("gt2",new ArrayList<>(Arrays.asList(1,1)),50),
    GT3("gt3",new ArrayList<>(Arrays.asList(1,1)),50),
    GT4("gt4",new ArrayList<>(Arrays.asList(1,1)),50),
    GT5("gt5",new ArrayList<>(Arrays.asList(1,1)),50),
    GT6("gt6",new ArrayList<>(Arrays.asList(1,1)),50),
    GT7("gt7",new ArrayList<>(Arrays.asList(1,1)),50),
    GT8("gt8",new ArrayList<>(Arrays.asList(1,1)),50),
    BT1("bt1",new ArrayList<>(Arrays.asList(1,1)),50),
    BT2("bt2",new ArrayList<>(Arrays.asList(1,1)),50),
    BT3("bt3",new ArrayList<>(Arrays.asList(1,1)),50),
    BT4("bt4",new ArrayList<>(Arrays.asList(1,1)),50),
    BT5("bt5",new ArrayList<>(Arrays.asList(1,1)),50),
    BT6("bt6",new ArrayList<>(Arrays.asList(1,1)),50),
    BT7("bt7",new ArrayList<>(Arrays.asList(1,1)),50),
    BT8("bt8",new ArrayList<>(Arrays.asList(1,1)),50),
